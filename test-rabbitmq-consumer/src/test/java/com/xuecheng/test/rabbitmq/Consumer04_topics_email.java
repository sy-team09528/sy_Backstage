...
public class Consumer04_topics_email {
    ...
    private static final String ROUTINGKEY_EMAIL="inform.#.email.#";//inform.email.sms
    ...
    public static void main(String[] args) throws Exception{
         ...
         * 1.交换机的名称
         * 2.交换机的类型
         * fanout:对应的rabbitmq的工作模式是publish/scribe
         ...
         * 1.queue 队列名称
         * 2.exchange 交换机名称
         * 3.routingKey 路由key，作用是交换机根据路由key的值将消息转发到指定的队列，在发布订阅模式设置为空字符串
         */
         ...
         * 参数明细
         * 1.queue 队列名称
         * 2.autoAck 自动回复，当笑给之接收到消息后要告诉mq消息已接受，如果将此参数设置为true表示会自动回复mq，如果设置为false要通过编程实现回复
